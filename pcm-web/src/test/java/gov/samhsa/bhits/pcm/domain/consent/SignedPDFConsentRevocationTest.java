...
import gov.samhsa.bhits.pcm.domain.AbstractDomainEventHandler;
import gov.samhsa.bhits.pcm.domain.DomainEventManager;
import gov.samhsa.bhits.pcm.domain.DomainEventServiceImpl;
import gov.samhsa.bhits.pcm.domain.consent.event.ConsentRevokedEvent;
