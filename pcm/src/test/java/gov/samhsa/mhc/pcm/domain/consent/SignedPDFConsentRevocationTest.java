...
import gov.samhsa.mhc.pcm.domain.AbstractDomainEventHandler;
import gov.samhsa.mhc.pcm.domain.DomainEventManager;
import gov.samhsa.mhc.pcm.domain.DomainEventServiceImpl;
import gov.samhsa.mhc.pcm.domain.consent.event.ConsentRevokedEvent;
