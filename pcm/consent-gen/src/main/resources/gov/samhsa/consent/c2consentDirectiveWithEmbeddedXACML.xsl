...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
        ...
        <entryRelationship typeCode="COMP"
            ...
            <organizer classCode="CLUSTER" moodCode="DEF">
                ...
                <component typeCode="COMP">
                    <!-- Reference to protected information -->
                    <observation classCode="OBS" moodCode="DEF">
                        <templateId root="2.16.840.1.113883.3.445.10" />
                        <code code="111111" codeSystemName="LOINC"
                              codeSystem="2.16.840.1.113883.6.1" displayName="Global Appraisal of Individual Needs (GAIN)" />
                        <effectiveTime value="201303122244" />
                    </observation>
                </component>
                <component>
                    ...
                    <observation classCode="OBS" moodCode="DEF">
                        ...
                        <value type="CD" code="371422002" codeSystemName="ActInformationSensitivityPolicy"
                               codeSystem="2.16.840.1.113883.1.11.20428" displayName="History of substance abuse (situation)" />
                        <code>
                ...
                <component>
                    ...
                    <observation classCode="OBS" moodCode="EVN">
                        ...
                        <value type="CE" code="R" codeSystem="2.16.840.1.113883.5.1063"
                ...
                <organizer classCode="CLUSTER" moodCode="DEF">
                    ...
                    <component>
                        ...
                        <observation classCode="OBS" moodCode="DEF">
                            ...
                            <code code="8319008" codeSystemName="SNOMED-CT"
                                  codeSystem="2.16.840.1.113883.6.96" displayName="Principal diagnosis" />
                            <value type="CD" code="371422002" codeSystemName="LOINC"
                                   codeSystem="2.16.840.1.113883.6.1" displayName="History of substance abuse (situation)" />
                            <code>
                                <xsl:value-of select="code"/>
                            </code>
                            <displayName>
    ...
    <xsl:variable name="purposeofuse">
        <xsl:for-each
            ...
            <!-- Purpose of use -->
            <code code="TREAT" codeSystem="2.16.840.1.113883.3.18.7.1"
                  codeSystemName="HL7 Purpose or Use" displayName="Treatment" />
            <code>
                <xsl:value-of select="code"/>
            </code>
            <displayName>
