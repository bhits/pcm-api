...
import gov.samhsa.pcm.domain.reference.AdverseEventTypeCode;
import gov.samhsa.pcm.domain.reference.AllergyReactionCodeDataOnDemand;
import gov.samhsa.pcm.domain.reference.AllergySeverityCodeDataOnDemand;
import gov.samhsa.pcm.domain.reference.AllergyStatusCodeDataOnDemand;
import gov.samhsa.pcm.domain.valueobject.CodedConcept;
import gov.samhsa.pcm.service.clinicaldata.AllergyService;
