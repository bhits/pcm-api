...
import gov.samhsa.pcm.domain.reference.AddressUseCode;
import gov.samhsa.pcm.domain.reference.AdministrativeGenderCodeDataOnDemand;
import gov.samhsa.pcm.domain.reference.CountryCode;
import gov.samhsa.pcm.domain.reference.EthnicGroupCodeDataOnDemand;
import gov.samhsa.pcm.domain.reference.LanguageCodeDataOnDemand;
import gov.samhsa.pcm.domain.reference.MaritalStatusCodeDataOnDemand;
import gov.samhsa.pcm.domain.reference.RaceCodeDataOnDemand;
import gov.samhsa.pcm.domain.reference.ReligiousAffiliationCodeDataOnDemand;
import gov.samhsa.pcm.domain.reference.StateCode;
