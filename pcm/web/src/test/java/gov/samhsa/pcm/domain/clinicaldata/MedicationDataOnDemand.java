package gov.samhsa.pcm.domain.clinicaldata;

import gov.samhsa.pcm.domain.patient.PatientDataOnDemand;
import gov.samhsa.pcm.domain.reference.BodySiteCodeDataOnDemand;
import gov.samhsa.pcm.domain.reference.MedicationStatusCodeDataOnDemand;
import gov.samhsa.pcm.domain.reference.ProductFormCodeDataOnDemand;
import gov.samhsa.pcm.domain.reference.RouteCodeDataOnDemand;
import gov.samhsa.pcm.domain.reference.UnitOfMeasureCode;
import gov.samhsa.pcm.domain.valueobject.CodedConcept;
import gov.samhsa.pcm.domain.valueobject.Quantity;
